            ...
            child:Column(
              children: <Widget>[
                ...
                HelpersViewLetrasToolTip(message: "●	Antes de realizar la pregunta el gestor social estará informado sobre el cronograma de pago y el periodo que comprende a la visita que se está realizando.\n"
                    ...
                    controller: _tip01),
                HelpersViewLetrasSubs.formItemsDesign( "01) ¿El usuario ha realizado el cobro correspondiente al último padrón? *"),
                ...
                HelpersViewLetrasToolTip(message: "●	Solo si responde la alternativa 1) saltar a la pregunta P03, de lo contrario pasar a la pregunta P04.\n",
                    controller: _tip02),
                HelpersViewLetrasSubs.formItemsDesign( "02) Usualmente ¿Cada cuánto tiempo el usuario cobra la pensión? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                Row(
                  children: [
                    const Text(
                  ...
                  child:Column(
                    children: <Widget>[
                      HelpersViewLetrasToolTip(message: "●	Si la respuesta de la persona usuaria es la alternativa 6) registre la información correspondiente.\n"
                          ...
                          controller: _tip03),
                      HelpersViewLetrasSubs.formItemsDesign( "04) Normalmente, de los 300 soles de la pensión que el usuario recibe ¿Cómo gasta el dinero? *"),
                  ...
                  child:Column(
                    children: <Widget>[
                      HelpersViewLetrasToolTip(message: "●	La suma de todas las alternativas escritas debe sumar 300 soles.\n"
                          ...
                          controller: _tip04),
                      HelpersViewLetrasSubs.formItemsDesign( "03) ¿Por qué el usuario no cobra la pensión, cada dos meses? *"),
                      HelpersViewLetrasSubs.formItemsDesignGris(Constants.checkAviso),
                      Row(
                        children: [
            ...
            child:Column(
              children: <Widget>[
                ...
                HelpersViewLetrasToolTip(message: "●  Recuerda que según la respuesta del usuario/a en la alternativa 7) tienen que especificar la información y registrar.",
                    controller: _tip06),
                HelpersViewLetrasSubs.formItemsDesign( "06) Actualmente. ¿A qué tipo de establecimiento de Salud, acude el usuario con frecuencia? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                ...
                HelpersViewLetrasToolTip(message: "●  Darle tiempo al usuario/a (a) para que reflexione su respuesta.",
                    controller: _tip07),
                HelpersViewLetrasSubs.formItemsDesign( "07) ¿El usuario se ha atendido en algún centro de salud/ puesto de salud/posta médica u hospital? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                Row(
                  children: [
                    const Text(
                    ...
                    child:Column(
                        children: <Widget>[
                          ...
                          HelpersViewLetrasToolTip(message: "●  Dejar al usuario (a) se tome el tiempo para recordar y marcar la alternativa que indique el usuario. Pueden marcar más de 2 alternativas.",
                              controller: _tip08),
                          HelpersViewLetrasSubs.formItemsDesign( "08) ¿Por qué el usuario no se atendió en algún centro de salud, puesto de salud/posta médica u hospital? *"),
                          HelpersViewLetrasSubs.formItemsDesignGris(Constants.checkAviso),
                    ...
                    child:Column(
                        children: <Widget>[
                          ...
                          HelpersViewLetrasToolTip(message: "●	Dejar al usuario (a) se tome el tiempo para recordar y marcar la alternativa que indique. Pueden ser más de 2 alternativas.\n"
                              ...
                              controller: _tip09),
                          HelpersViewLetrasSubs.formItemsDesign( "09) ¿Cuáles son los servicios a los que el usuario accede con mayor frecuencia, cuando se atiende en el centro de salud, puesto de salud/posta médica u hospital? *"),
                          HelpersViewLetrasSubs.formItemsDesignGris(Constants.checkAviso),
                ...
                HelpersViewLetrasToolTip(message: "●  Dejar al usuario (a) se tome el tiempo para recordar y marcar la alternativa que se indique, recuerde que puede marcar solo una alternativa, la que mas se aproxime a la frecuencia de su atención.",
                    controller: _tip10),
                HelpersViewLetrasSubs.formItemsDesign( "10) ¿Con qué frecuencia se atiende el usuario en el centro de salud, puesto de salud/posta médica u hospital?"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
            ...
            child:Column(
              children: <Widget>[
                ...
                HelpersViewLetrasToolTip(message: "●	Estas preguntas son aplicadas por el gestor social o quien haga sus veces preguntando a la persona usuaria y observando el contexto, ponga énfasis en las preguntas que están resaltadas en negrita, la calificación del 01 al 05 es a “CRITERIO” del gestor social o quien haga sus veces.\n"
                    ...
                    controller: _tip11),
                HelpersViewLetrasSubs.formItemsDesign( "11) ¿Con quién vive el usuario? *"),
                ...
                HelpersViewLetrasToolTip(message: "●	Se recomienda al gestor social o quien haga sus veces, estar atento a las alternativas 1 y 2 y seguidamente pasar a las opciones que se indica, recuerde que tiene que dar el tiempo para que la persona usuaria manifieste su respuesta.\n",
                    controller: _tip12),
                HelpersViewLetrasSubs.formItemsDesign( "12) ¿El usuario tiene amigos, familiares, vecinos a los que suele visitar? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                ...
                Visibility(
                  ...
                  child:Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("¿El usuario ha recibido visita de algún familiar, suele visitarlos por lo menos una vez a la semana? o durante la semana participa"
                ...
                Visibility(
                  ...
                  child:Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: [
                          HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("El usuario Suele salir fuera de su hogar, con o sin compañía, por lo menos una vez a la semana."),
                          const Spacer(),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Radio<TieneFamiliaABCDE>(
                      ...
                      Row(
                        children: [
                          HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("El usuario Recibe visita de algún familiar en su hogar? Por lo menos una vez por semana."),
                          const Spacer(),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Radio<TieneFamiliaABCDE>(
                ...
                HelpersViewLetrasToolTip(message: "●	El gestor social, debe marcar las alternativas 1) No requiere ayuda, la persona usuaria es independiente y no necesita de nada ni de nadie en la realización de sus actividades, la alternativa 2) precisa que la persona usuaria no es completamente independiente en su vida cotidiana, necesita de un cuidador para la realización de sus actividades o de una red informal unidad de vida social que agrupa a personas enlazadas por lazos familiares, o de una red formal que agrupa a personas enlazadas por lazos familiares, sociales.\n",
                    controller: _tip13),
                HelpersViewLetrasSubs.formItemsDesign( "13) ¿El usuario recibe ayuda en las actividades diarias? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                ...
                HelpersViewLetrasToolTip(message: "●	Valorar en que rango de ingresos recibe el hogar en su conjunto, en base al salario mínimo 2024 (S/1025)\n",
                    controller: _tip14),
                HelpersViewLetrasSubs.formItemsDesign( "14) ¿Cual es el ingreso economico en el hogar del usuario? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),


                Row(
                  children: [
                    HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("¿Recibe  más de S/2,050 mensualmente?"),
                    const Spacer(),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                ...
                Row(
                  children: [
                    HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("¿Recibe más de S/ 1537.50 hasta S/ 2,050 mensualmente?."),
                    const Spacer(),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Radio<IngresoEconomico >(
                ...
                Row(
                  children: [
                    HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("¿Recibe mas de S/ 1025 hasta S/ 1537.50 mensualmente?"),
                    const Spacer(),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Radio<IngresoEconomico >(
                ...
                Row(
                  children: [
                    HelpersViewLetrasSubsGris.formItemsDesignOPTIONTEXT("Recibe igual o menos de S/ 1025 mensualmente."),
                    const Spacer(),
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Radio<IngresoEconomico >(
            ...
            child:Column(
              children: <Widget>[
                ...
                HelpersViewLetrasToolTip(message: "●	Para registrar esta pregunta y valorarla el gestor social, tendría que considerar las siguientes precisiones:\n"
                    ...
                    controller: _tip15),
                HelpersViewLetrasSubs.formItemsDesign( "15) ¿Que tipo de vivienda tiene el usuario? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
                ...
                HelpersViewLetrasToolTip(message: "●	Esta pregunta corresponde ser llenada solo por el gestor social o quien corresponda.\n",
                    controller: _tip17),
                HelpersViewLetrasSubs.formItemsDesign( "17) ¿De qué temas le interesaría al usuario, informarse en las siguientes visitas? *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.checkAviso),
                ...
                HelpersViewLetrasToolTip(message: "●	Esta pregunta corresponde ser llenada solo por el gestor social o quien corresponda.\n",
                    controller: _tip18),
                HelpersViewLetrasSubs.formItemsDesign( "18) A la fecha, el usuario, desarrolla algún tipo de emprendimiento *"),
                HelpersViewLetrasSubs.formItemsDesignGris(Constants.circleAviso),
