...
class Respuestapercepcion {
  ...
  factory Respuestapercepcion.fromJson(dynamic json) {
    return Respuestapercepcion(
      ...
      p01percepcion: json['p01percepcion'] as int?,
      p02percepcion: json['p02percepcion'] as int?,
      p03percepcion: json['p03percepcion'] as int?,
      p04percepcion: json['p04percepcion'] as int?,
      p05percepcion: json['p05percepcion'] as int?,
      p06percepcion: json['p06percepcion'] as int?,
      p07percepcion: json['p07percepcion'] as int?,
      p08percepcion: json['p08percepcion'] as int?,
      ...
      p19percepcion: json['p19percepcion'] as int?,
      ...
      p42percepcion: json['p42percepcion'] as int?,
      ...
      p50percepcion: json['p50percepcion'] as int?,
      p51percepcion: json['p51percepcion'] as int?,
      p52percepcion: json['p52percepcion'] as int?,
      p53percepcion: json['p53percepcion'] as int?,
      p54percepcion: json['p54percepcion'] as int?,
